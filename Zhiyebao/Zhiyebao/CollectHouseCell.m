...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.detailLable = [[UILabel alloc] initWithFrame:CGRectMake(130.0, 48.0, 200.0, 20.0)];
        self.detailLable.backgroundColor = [UIColor clearColor];
        self.detailLable.font = [UIFont systemFontOfSize:10.0];
        self.detailLable.textColor = [UIColor colorWithCGColor:UIColorFromRGB(153.0, 153.0, 153.0).CGColor];
...
-(void)setCellInfo:(House*)house
{
    ...
    self.detailLable.text = house.houseTypeTitle;
...
- (void)layoutSubviews
{
    ...
    self.textLabel.frame = CGRectMake(130.0, 5.0, 180.0, 50.0);
     self.detailLable.frame = CGRectMake(130.0, 48.0, 180.0, 20.0);
